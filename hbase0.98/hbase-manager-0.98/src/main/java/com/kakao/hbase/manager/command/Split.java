...
public class Split implements Command {
    ...
    public static String usage() {
        return "Split table with the given information.\n"
                ...
                + "  rule names:\n"
                + "    HexString <#regions>: Use when uniformly distributed hexadecimal value.\n"
                + "    DecimalString <#regions> <#cardinality>: Use when uniformly distributed decimal value.\n"
                + "    Uniform <#regions>: Use when the keys are approximately uniform random bytes.\n"
                + Args.commonUsage();
    }
