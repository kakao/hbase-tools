...
public class Split implements Command {
    ...
    public static String usage() {
        return "Split table with the given information.\n"
                ...
                + "  rule names:\n"
                + "    HexString <#regions>: Useful when uniformly distributed hexadecimal value.\n"
                + "    DecimalString <#regions> <#cardinality>: Useful when uniformly distributed decimal value.\n"
                + "    Uniform <#regions>: Useful when the keys are approximately uniform random bytes.\n"
                + Args.commonUsage();
    }
